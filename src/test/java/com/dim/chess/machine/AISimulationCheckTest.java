...
public class AISimulationCheckTest {

	@Test
	public void testAISimulationManualCheckmateBlackLevel_AI_3AndDeduction_1() {
		System.out.println("\n------------------------------------------------------------------------------");		
		System.out.println("\n-----------------testAISimulationManualCheckmateBlackLevel_AI_3AndDeduction_1()-----------------------");
		...
		game.getChessboard().printDebugChessboard(game.getChessboard(), "testAISimulationManualCheckmateBlackLevel_AI_3AndDeduction_1");
		...
		Double score = PieceHelper.getTotalScoreChessboardPiecesByPlayer(game.getChessboard().getSquaresChessboard(), TypePlayer.B);
		Assert.assertEquals(pair.getLeft(), PositionChessboard.G8);
		Assert.assertEquals(pair.getRight(), PositionChessboard.G1);
		Assert.assertEquals(bestMovementSimulation.getBestScoreSimulated(), score);
	}
	
	@Test
	public void testAISimulationManualCheckmateBlackLevel_AI_1AndDeduction_1() {
		System.out.println("\n------------------------------------------------------------------------------");		
		System.out.println("\n-----------------testAISimulationManualCheckmateBlackLevel_AI_3AndDeduction_2()-----------------------");
		Chessboard chessboard = new Chessboard(new Player(TypePlayer.W), new Player(TypePlayer.B));		
		King kingW = new King(TypeColor.WHITE, TypePlayer.W);
		King kingB = new King(TypeColor.BLACK, TypePlayer.B);
		Rook rook1 = new Rook(TypeColor.BLACK, TypePlayer.W);
		Rook rook2 = new Rook(TypeColor.BLACK, TypePlayer.W);
		chessboard.addPiece(PositionChessboard.E1, kingW);
		chessboard.addPiece(PositionChessboard.E8, kingB);
		chessboard.addPiece(PositionChessboard.H7, rook1);
		chessboard.addPiece(PositionChessboard.G1, rook2);
		...
		game.getChessboard().printDebugChessboard(game.getChessboard(), "testAISimulationManualCheckmateBlackLevel_AI_1AndDeduction_1");
		...
		Double score = PieceHelper.getTotalScoreChessboardPiecesByPlayer(game.getChessboard().getSquaresChessboard(), TypePlayer.B);
		Assert.assertEquals(pair.getLeft(), PositionChessboard.E8);
		Assert.assertEquals(pair.getRight(), PositionChessboard.F8);
		Assert.assertEquals(bestMovementSimulation.getBestScoreSimulated(), score);
	}
}
