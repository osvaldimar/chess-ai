...
public class AISimulationDrawTest {

	@Test
	public void testAISimulationManualDrawBlackLevel_AI_3AndDeduction_1() {
		System.out.println("\n------------------------------------------------------------------------------");		
		System.out.println("\n-----------------testAISimulationManualDrawBlackLevel_AI_3AndDeduction_1()-----------------------");
		...
		Rook rook3 = new Rook(TypeColor.BLACK, TypePlayer.B);
		chessboard.addPiece(PositionChessboard.E1, kingW);
		chessboard.addPiece(PositionChessboard.E8, kingB);
		chessboard.addPiece(PositionChessboard.G2, rook1);
		chessboard.addPiece(PositionChessboard.G3, rook2);
		chessboard.addPiece(PositionChessboard.D8, rook3);
		...
		response = service.selectAndMovePiece("E8", "B");
		response = service.selectAndMovePiece("F8", "B");
		response = service.selectAndMovePiece("F1", "W");
		response = service.selectAndMovePiece("E1", "W");
		...
		game.getChessboard().printDebugChessboard(game.getChessboard(), "testAISimulationManualDrawBlackLevel_AI_3AndDeduction_1");
		...
		Assert.assertEquals(response.getStatus(), ResponseChessboard.StatusResponse.DRAW_3_POSITIONS.toString());
	}
